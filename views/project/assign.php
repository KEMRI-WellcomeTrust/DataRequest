...
<div class="form-group">
        <?php 
            $url =  Url::to(['project/assign', 'id'=>$model->id]); 
        ?>
        <?= Html::submitButton('Submit', ['class' =>'btn btn-success','onclick'=>"ajaxFormSubmit('$url','project-form-div-$id','project-form-$id',1); return false;"]) ?>
    </div>
